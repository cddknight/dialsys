 ...
 *                                                                                                                    *
 *  File Gauge.c part of Gauge is free software: you can redistribute it and/or modify it under the terms of the GNU  *
...
aboutCallback (guint data)
{
	...
	gtk_show_about_dialog (dialConfig.mainWindow,
			...
			"copyright", "Copyright © 2005 - 2023 Chris Knight <chris@theknight.co.uk>",
			"logo", defaultIcon,
			"version", verString,
