 ...
 *                                                                                                                    *
 *  File GaugeWeather.c part of Gauge is free software: you can redistribute it and/or modify it under the terms of   *
	...
	while (1)
	{
		...
		else if (value[i] == ',' || value[i] == 0)
		{
			if (b == 1)
			{
				...
				for (n = 0; n < 7; ++n)
				{
					if ((level == 1 && (strcmp ("Today", &buffers[0][0]) == 0 || strcmp ("Tonight", &buffers[0][0]) == 0)) ||
							strcmp (daysOfWeek[n], &buffers[0][0]) == 0)
					{
